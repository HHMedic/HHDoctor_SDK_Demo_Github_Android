...
* [二、SDK接入引用说明](#二sdk接入引用说明)
   ...
   * [2. SDK功能介绍](#2-sdk功能介绍)
      ...
      * [2.13 使用三方约定数据登录](#213-使用三方约定数据登录)
   * [3. 回调说明](#3-回调说明)
...
> 注意该方法需要提前双方约定数据字段才可以使用

```java
public static void loginForThirdId(Context context, HashMap<String,Object> data,HHLoginListener listener)
```
...
| --- | --- |
|Context context|当前上下文，一般为当前Activity|
|HashMap<String,Object> data|接入方和和缓约定好的数据字段集合|
|HHLoginListener listener|登录回调代理|
