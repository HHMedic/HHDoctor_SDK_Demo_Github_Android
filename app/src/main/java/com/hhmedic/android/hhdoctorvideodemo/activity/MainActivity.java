...
public class MainActivity extends BaseActivity {
    ...
    protected void initUI() {
        ...
        ((EditText) findViewById(R.id.third_info)).setText(getString(R.string.third_login_default_info));
    }
    ...
    private void loginWithThirdId() {
        try {
            String info = ((EditText) findViewById(R.id.third_info)).getText().toString().trim();
            Gson gson = new Gson();
            Type type = new TypeToken<HashMap<String, Object>>() {
            }.getType();
            HashMap<String, Object> params = gson.fromJson(info, type);
            HHDoctor.loginForThirdId(this, params, new HHLoginListener() {
                @Override
                public void onSuccess() {
                    HHDoctor.message(MainActivity.this);
                }
