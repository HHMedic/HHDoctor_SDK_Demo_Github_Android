...
//        mOrderIdEdit.setText(LocalConfig.DefaultCallOrderId);
        ...
        findViewById(R.id.direct_call).setOnClickListener(this);
...
//                break;
            case R.id.direct_call:
                HHDoctor.call(this, "D1F48432C4701BDDFAAA052005276606BB7A1F1299CAF508460D59212594CED3", new HHCallListener() {
                    @Override
